...
?>
        <?php
            $viewpostid = mysqli_real_escape_string($db->link,$_GET['viewpostid']);//validation
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?php echo $postresult['image'];?>" height="100px" width="250px" alt=""><br>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <textarea class="tinymce" id="elm1"  readonly>
