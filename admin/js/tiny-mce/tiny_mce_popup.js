...
tinyMCEPopup = {
  init: function () {
    ...
    b.dom = b.editor.windowManager.createInstance(
  ...
  resizeToInnerSize: function () {
    ...
    setTimeout(function () {
      ...
      a.editor.windowManager.resizeBy(
        a.getWindowArg("mce_width") - b.w,
        a.getWindowArg("mce_height") - b.h,
        a.id || window
      );
    }, 10);
  },
